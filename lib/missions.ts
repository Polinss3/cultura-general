...
// El texto de cada misión vive en i18n bajo `missions.<id>` (ver locales/*.json).
const POOL: Mission[] = [
  { id: 'm_learn_10',       icon: '📚', goal: 10, kind: 'learn_answer' },
  { id: 'm_learn_correct8', icon: '✅', goal: 8,  kind: 'learn_correct' },
  { id: 'm_speed_6',        icon: '⚡', goal: 6,  kind: 'speed_correct' },
  { id: 'm_speed_play2',    icon: '🎮', goal: 2,  kind: 'speed_play' },
