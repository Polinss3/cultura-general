...
> (`docs/APPODEAL_SAFE_INTEGRATION.md`) hay que revisar "no ads, no in-app
> purchases" aquí y en los otros tres ficheros ANTES de subir la build.

## Name (max 30)
CG Trivia: General Knowledge

<!-- Fallbacks si el nombre está cogido:
- CG Trivia – Quiz & Knowledge
- CG Trivia: Quiz Game
-->
...
Over 1,500 questions across 13 categories: history, science, art, geography, philosophy, sports, biology, film, music, literature, technology, mythology and astronomy. Every wrong answer comes with an explanation.
