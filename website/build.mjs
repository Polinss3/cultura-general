  ...
  es: {
    privacy: {
      ...
      sections: [
        ...
        ["5. Base jurídica", ["Tratamos los datos necesarios para prestarte el servicio y ejecutar las condiciones de uso; para cumplir obligaciones legales; y, cuando procede, por interés legítimo en proteger y mejorar la app. El seguimiento entre apps y la medición de nuestras campañas de captación se basan en tu consentimiento, que puedes retirar en cualquier momento. Los anuncios que ves dentro de la app son propios y no dependen de ese consentimiento."], []],
        ["6. Proveedores", ["Usamos Supabase para autenticación, base de datos y funciones de servidor; Sentry para diagnosticar errores; AppsFlyer y Meta para medir nuestras campañas de captación cuando has consentido la medición y se cumplen los permisos del sistema; y RevenueCat para gestionar la suscripción CG PRO. La publicidad que se muestra dentro de la app es propia: la sirve In-House Ads, un servicio del mismo responsable, que no usa identificadores publicitarios ni redes de terceros. Apple y Google también pueden tratar información al distribuir la app o autenticarte."], [], [
          ["Privacidad de Supabase", "https://supabase.com/privacy"], ["Privacidad de Sentry", "https://sentry.io/privacy/"], ["Privacidad de AppsFlyer", "https://www.appsflyer.com/legal/privacy-policy/"], ["Privacidad de Meta", "https://www.facebook.com/privacy/policy/"], ["Privacidad de RevenueCat", "https://www.revenuecat.com/privacy"]
        ]],
        ["7. Compras y suscripciones", ["CG PRO es una compra opcional gestionada por la tienda de tu dispositivo. RevenueCat recibe los identificadores de compra y el estado de la suscripción necesarios para validar y restaurar el acceso, pero ni la app ni RevenueCat reciben los datos completos de tu tarjeta.", "Las suscripciones se renuevan y se cancelan desde tu cuenta de Apple o Google. El precio, la duración, cualquier prueba gratuita y la fecha de renovación se muestran en la hoja de compra oficial antes de confirmar. Las solicitudes de reembolso se tramitan con la tienda correspondiente."], []],
        ["8. Publicidad, edad y medición", ["La publicidad de CG Trivia es propia: solo promociona aplicaciones y webs del mismo responsable, no usa identificadores publicitarios, perfiles ni redes de terceros, y no escribe cookies ni almacenamiento persistente en el dispositivo. Los anuncios salen en pausas naturales del juego —el resultado de la pregunta diaria o el final de una partida de contrarreloj, de una escalada, de una ronda de Mundo o de Años— o cuando eliges voluntariamente ver uno a cambio de una recompensa. Con la suscripción CG PRO no se solicita ni se muestra ningún anuncio.", "Antes de mostrar el primero preguntamos tu tramo de edad y, por separado, si aceptas que midamos nuestras campañas de captación. Son decisiones independientes."], ["Menores de 16 años: no se muestran anuncios y no se inicializan AppsFlyer ni Meta. La app completa sigue disponible.", "Solo lo básico: no pedimos ATT ni iniciamos AppsFlyer o Meta. Verás exactamente los mismos anuncios.", "Permitir medición: en iOS pedimos primero el permiso oficial App Tracking Transparency. AppsFlyer y Meta pueden medir instalaciones y eventos de nuestras campañas de captación. No cambia qué anuncios se muestran dentro de la app."], [["Opciones de privacidad", "/privacy-choices"]]],
        ["9. Notificaciones", ["Si las activas, la app envía un recordatorio diario a las 9:00 para no perder la racha. Son notificaciones locales: las programa el propio dispositivo y su contenido no pasa por ningún servidor. Se desactivan desde Perfil > Ajustes o desde los ajustes del sistema."], []],
    ...
    "privacy-choices": {
      ...
      sections: [
        ["En la app", ["Abre Perfil > Ajustes > Privacidad y anuncios para revisar o cambiar tu elección. Ahí decides tu tramo de edad, que determina si se muestran anuncios, y si aceptas que midamos nuestras campañas de captación. Al retirar la medición detenemos AppsFlyer y Meta; los anuncios, que son propios y no usan identificadores, no cambian.", "Con la suscripción CG PRO no se solicita ni se muestra ningún anuncio."], []],
        ["Si eres menor de 16 años", ["Selecciona el tramo de edad correcto. No se muestra publicidad y no se inicializan AppsFlyer ni Meta; puedes seguir usando todas las funciones del juego."], []],
...
pages.en = {
  privacy: { eyebrow: "CLEAR PRIVACY", title: "Privacy policy", intro: "This policy explains what information CG Trivia processes, why it is used, and how you can exercise your rights.", sections: [
    ...
    ["5. Legal grounds", ["We process data required to provide the service and perform these terms, comply with legal duties, and pursue legitimate interests in protecting and improving the app. Cross-app tracking and the measurement of our own acquisition campaigns rely on consent, which you can withdraw. The ads shown inside the app are first-party and do not depend on that consent."], []],
    ["6. Providers", ["We use Supabase for authentication, database and server functions; Sentry for error diagnostics; AppsFlyer and Meta to measure our own acquisition campaigns when you have consented to measurement and system permissions allow it; and RevenueCat to manage the CG PRO subscription. Advertising shown inside the app is first-party: it is served by In-House Ads, a service run by the same controller, which uses no advertising identifiers and no third-party networks. Apple and Google may process data when distributing the app or authenticating you."], [], [["Supabase privacy", "https://supabase.com/privacy"], ["Sentry privacy", "https://sentry.io/privacy/"], ["AppsFlyer privacy", "https://www.appsflyer.com/legal/privacy-policy/"], ["Meta privacy", "https://www.facebook.com/privacy/policy/"], ["RevenueCat privacy", "https://www.revenuecat.com/privacy"]]],
    ["7. Purchases and subscriptions", ["CG PRO is an optional purchase handled by your device's store. RevenueCat receives the purchase identifiers and subscription status needed to validate and restore access, but neither the app nor RevenueCat receives your full card details.", "Subscriptions renew and are cancelled from your Apple or Google account. Price, duration, any free trial and the renewal date are shown on the official purchase sheet before you confirm. Refund requests are handled by the corresponding store."], []],
    ["8. Advertising, age and measurement", ["CG Trivia's advertising is first-party: it only promotes apps and sites run by the same controller, it uses no advertising identifiers, profiles or third-party networks, and it writes no cookies or persistent storage on the device. Ads appear at natural breaks in play — the result of the daily question, or the end of a Time Attack run, a Climb Mode run, a World round or a Years round — or when you voluntarily choose to watch one in exchange for a reward. With the CG PRO subscription no ad is ever requested or shown.", "Before showing the first one we ask for your age bracket and, separately, whether you accept measurement of our acquisition campaigns. They are independent decisions."], ["Under 16: no ads are shown and AppsFlyer and Meta are not initialized. The whole app remains available.", "Essentials only: we do not request ATT or start AppsFlyer or Meta. You will see exactly the same ads.", "Allow measurement: on iOS we first ask for the official App Tracking Transparency permission. AppsFlyer and Meta may then measure installs and events from our acquisition campaigns. It does not change which ads are shown inside the app."], [["Privacy choices", "/en/privacy-choices"]]],
    ["9. Notifications", ["If you turn them on, the app sends a daily reminder at 9:00 so you do not lose your streak. They are local notifications: your own device schedules them and their content never travels through a server. Turn them off under Profile > Settings or in your system settings."], []],
    ...
    ["12. Your rights", ["Depending on where you live, you may request access, correction, deletion, objection, restriction and portability, and withdraw consent."], ["You can delete your account under Profile > Danger zone, without leaving the app.", "You can change your age bracket and your measurement choice under Profile > Settings > Privacy and ads.", "On iPhone or iPad you can withdraw tracking permission under Settings > Privacy & Security > Tracking.", `For any other request, write to us at ${email}.`], [["How to delete your account", "/en/data-deletion"], ["Privacy choices", "/en/privacy-choices"], ["Spanish Data Protection Agency", "https://www.aepd.es/"]]],
    ["13. Children", ["CG Trivia is a general-audience app and is not directed exclusively at children. The age at which someone can consent on their own varies by country: we apply a single cut-off of 16, the highest required across the European Economic Area.", "We show no advertising and start no measurement SDKs for anyone who indicates they are under 16. Contact us if you believe a child supplied information without authorization."], []],
  ...
  "privacy-choices": { eyebrow: "YOUR CHOICE", title: "Privacy choices", intro: "CG Trivia lets you control advertising and tracking in the app and operating system.", sections: [
    ["In the app", ["Open Profile > Settings > Privacy and ads to review or change your choice. There you set your age bracket, which decides whether ads are shown, and whether you accept measurement of our acquisition campaigns. Withdrawing measurement stops AppsFlyer and Meta; the ads themselves are first-party and use no identifiers, so they do not change.", "With the CG PRO subscription no ad is ever requested or shown."], []],
    ["If you are under 16", ["Select the correct age bracket. No advertising is shown and AppsFlyer and Meta are not initialized; you can use every game feature."], []],
