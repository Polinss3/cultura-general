...
const updatedEs = "2 de agosto de 2026";
const updatedEn = "August 2, 2026";
  ...
  es: {
    privacy: {
      ...
      sections: [
        ...
        ["7. Publicidad, edad y atribución", ["Antes de inicializar los sistemas publicitarios solicitamos un tramo de edad y una elección informada. Las personas menores de 16 años pueden usar la app sin anuncios y no inicializamos AppLovin, AppsFlyer ni Meta.", "Si eliges anuncios contextuales, comunicamos a AppLovin que no consientes personalización y que no se vendan o compartan datos para publicidad dirigida. No pedimos ATT ni iniciamos AppsFlyer o Meta.", "Si eliges anuncios personalizados, en iOS pedimos primero el permiso oficial App Tracking Transparency. AppLovin puede tratar identificadores y actividad publicitaria para seleccionar, limitar y medir anuncios; AppsFlyer y Meta pueden medir instalaciones y eventos de campaña. Puedes cambiar de opción desde Ajustes."], []],
        ["8. Sentry y seguridad", ["Sentry puede recibir la pila técnica del error, versiones de la app y del sistema y un identificador interno para agrupar incidencias. Configuramos el servicio para reducir datos personales y no enviar deliberadamente tu correo, nombre de usuario o contenido de preguntas.", "Las comunicaciones usan HTTPS/TLS y aplicamos controles de acceso en la base de datos. Ningún sistema es infalible, pero mantenemos medidas proporcionadas al riesgo."], []],
        ["9. Conservación y transferencias", ["Conservamos la cuenta y el progreso mientras esté activa o hasta que solicites su eliminación. Ciertos registros técnicos, copias de seguridad o datos necesarios para prevenir fraude y cumplir obligaciones pueden permanecer durante plazos limitados. Algunos proveedores pueden tratar información fuera del Espacio Económico Europeo con sus garantías contractuales y legales aplicables."], []],
        ["10. Tus derechos", ["Según tu lugar de residencia puedes solicitar acceso, rectificación, supresión, oposición, limitación y portabilidad, así como retirar el consentimiento. Puedes eliminar la cuenta desde Perfil > Zona peligrosa o escribirnos. También puedes reclamar ante la Agencia Española de Protección de Datos o tu autoridad local."], [], [["Cómo eliminar tu cuenta", "/data-deletion"], ["Opciones de privacidad", "/privacy-choices"], ["Agencia Española de Protección de Datos", "https://www.aepd.es/"]]],
        ["11. Menores", ["CG Trivia es una app de público general y no está dirigida exclusivamente a menores. No usamos los SDK de publicidad o atribución con quien indique ser menor de 16 años. Si crees que un menor nos ha facilitado información sin autorización, contáctanos para revisarla y eliminarla cuando proceda."], []],
        ["12. Esta web y cambios", ["La web no crea cuentas, no usa analítica ni instala cookies publicitarias. El alojamiento puede generar registros técnicos básicos para servir y proteger el sitio.", "Actualizaremos esta política si cambian las funciones, proveedores o requisitos legales. Publicaremos aquí la nueva versión y su fecha de vigencia."], []],
      ],
    },
    terms: {
...
pages.en = {
  privacy: { eyebrow: "CLEAR PRIVACY", title: "Privacy policy", intro: "This policy explains what information CG Trivia processes, why it is used, and how you can exercise your rights.", sections: [
    ...
    ["7. Advertising, age and attribution", ["Before initializing advertising systems, we ask for an age bracket and informed choice. Users under 16 can use the app without ads and we do not initialize AppLovin, AppsFlyer or Meta.", "If you choose contextual ads, we tell AppLovin you do not consent to personalization or sale/sharing for targeted ads. We do not request ATT or start AppsFlyer or Meta.", "If you choose personalized ads, iOS first asks for App Tracking Transparency permission. AppLovin may process identifiers and ad activity to select, limit and measure ads; AppsFlyer and Meta may measure campaign installs and events. You can change your choice in Settings."], []],
    ["8. Sentry and security", ["Sentry may receive technical stack traces, app and OS versions and an internal identifier to group incidents. We configure it to reduce personal data and do not deliberately send your email, username or question content.", "Communications use HTTPS/TLS and database access controls. No system is infallible, but we maintain safeguards proportionate to risk."], []],
    ["9. Retention and transfers", ["We retain the account and progress while active or until deletion. Technical logs, backups or information needed to prevent fraud and meet legal duties may remain for limited periods. Providers may process data outside the EEA under applicable safeguards."], []],
    ["10. Your rights", ["Depending on where you live, you may request access, correction, deletion, objection, restriction and portability, and withdraw consent. Delete your account under Profile > Danger zone or email us. You may also complain to the Spanish Data Protection Agency or your local authority."], [], [["How to delete your account", "/en/data-deletion"], ["Privacy choices", "/en/privacy-choices"], ["Spanish Data Protection Agency", "https://www.aepd.es/"]]],
    ["11. Children", ["CG Trivia is a general-audience app and is not directed exclusively at children. We do not use advertising or attribution SDKs with anyone who indicates they are under 16. Contact us if you believe a child supplied information without authorization."], []],
    ["12. This website and changes", ["The website does not create accounts, use analytics or set advertising cookies. Hosting may generate basic technical logs to serve and protect it.", "We will update this policy when features, providers or legal requirements change, publishing the new version and effective date here."], []],
  ]},
